...
import com.christdoes.notaris.service.UserProfileService;
import com.christdoes.notaris.service.dto.UserProfileDTO;
import com.christdoes.notaris.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.christdoes.notaris.domain.UserProfile}.
 */
@RestController
...
public class UserProfileResource {
    ...
    private static final String ENTITY_NAME = "notariesUserProfile";
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<UserProfileDTO>> getUserProfile(@PathVariable("id") UUID id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteUserProfile(@PathVariable("id") UUID id) {
