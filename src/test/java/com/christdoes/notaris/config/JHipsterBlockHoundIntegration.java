package com.christdoes.notaris.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.christdoes.notaris.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.christdoes.notaris.security.DomainUserDetailsService", "createSpringSecurityUser");
